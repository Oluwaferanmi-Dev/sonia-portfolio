        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-dark-400 mb-6 leading-relaxed">
              a creative storyteller blending visuals, words, and digital strategy to help brands shine online.
              Let's make content that feels real, intentional, and impossible to scroll past.
            </p>
            <a 
              href="#portfolio" 
