          ...
          <div className="w-full md:w-2/5 mb-8 md:mb-0 animate-fade-in">
            <div className="relative">
              <div className="w-full h-96 rounded-2xl overflow-hidden shadow-lg">
                <img src={soniaImage} alt="Sonia U." className="w-full h-full object-cover" />
              </div>
          ...
          <div className="w-full md:w-3/5 animate-slide-up">
            ...
            <div className="bg-secondary-100 p-6 md:p-8 rounded-2xl">
              <p className="text-dark-500 leading-relaxed mb-4">
                I'm a storyteller at heart, using visuals, words, and strategy to help brands connect deeply with their
                audience. As a Social Media Manager and Content Creator, I blend creativity with insight—crafting
                scroll-stopping content, building communities, and turning everyday ideas into engaging digital
                experiences.
              </p>
              <p className="text-dark-500 leading-relaxed">
                From fashion and skincare brands to the academic space, I've led creative direction, shaped brand
                voices, and developed campaigns that don't just follow trends—they spark them. Whether I'm behind the
                camera, curating a content calendar, or editing a reel, my goal is always the same: to create content
                that feels real, intentional, and impactful.
              </p>
            </div>
