        ...
        <div className="flex flex-col-reverse lg:flex-row gap-12 animate-slide-up">
          <div className="w-full lg:w-1/2">
            <div className="bg-primary-100 p-6 md:p-8 rounded-2xl shadow-sm">
              <h3 className="font-serif text-xl font-medium text-dark-500 mb-6">Contact Information</h3>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+2348148760227" className="text-primary-700 hover:text-primary-800 transition-colors">
                      +234 814 876 0227
                    </a>
                  </div>
                </div>
